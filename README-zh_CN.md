...
**这是一个 Minecraft 车万女仆的附属模组，将《车万女仆》与《Iron 的法术与魔法书》两部模组深度融合，为女仆赋予强大的魔法战斗能力。**

---

## 🌟 模组简介

**酒狐的魔法书** 是一个为《车万女仆》和《Iron 的法术与魔法书》设计的联动模组，旨在扩展《车万女仆》模组中女仆的魔法战斗能力。通过与《Iron 的法术与魔法书》模组的结合，女仆可以穿戴魔法书作为饰品，在战斗中使用各种强大的魔法攻击和召唤技能。

本模组为女仆引入了全新的“法术攻击”和“法术支援”模式，并支持使用 Geckolib 动画系统，使女仆在施法时能够展示施法动画（动画资源基于《Iron 的法术与魔法书》原版动画转换）。
...
- **法术支援模式**：女仆在法术支援模式下，不会主动攻击敌人，而是为附近的主人或同阵营生物（包括同主人的女仆）提供法术支援。
- **魔力系统支持**：
    - 女仆施法会消耗魔力。
    - 魔力上限道具上的“最大法力值”词条影响。
    - 当女仆成功“渡劫”（被闪电击中）后，魔力恢复速度将固定为每 0.5 秒恢复 100% 魔力，相当于“无限魔力”，但仍会受最大法力值限制。
- **丰富法术类型**：
    - 攻击类法术
    - 防御类法术
    - 召唤类法术
...
- **Geckolib 动画支持**：
    ...
    - 动画资源基于《Iron 的法术与魔法书》原版动画转换，目前可能存在骨骼错位等问题，将在后续版本中逐步修复与优化。
...
- **依赖模组**：
    ...
    - [Iron 的法术与魔法书 (Iron's Spells 'n Spellbooks)](https://www.curseforge.com/minecraft/mc-mods/irons-spells-n-spellbooks)
